...
ALTER TABLE "Sales_Fact"
DROP CONSTRAINT "FK_Sales_Fact_Customer";

ALTER TABLE "Sales_Fact"
DROP CONSTRAINT "FK_Sales_Fact_Time";

ALTER TABLE "Sales_Fact"
DROP CONSTRAINT "FK_Sales_Fact_Employee";

ALTER TABLE "Sales_Fact"
DROP CONSTRAINT "FK_Sales_Fact_Product";

ALTER TABLE "Sales_Fact"
DROP CONSTRAINT "FK_Sales_Fact_Shipper";
